...
This library is (or should I say was) developed by a giant company and yet they did not respond to any of the bug reports anymore. What's funnier there's a note explaining why they are doing some trickery to to fix issue caused by different firefox behaviour than all other browser engines that is directly tied to my issue. The bug description is as below: 
...
You're most likely now thinking, well that's library dev problem - well, no. It's different from other browsers and it's still **not** fixed after 7 freaking years! But yeah, firefox is famous for not giving a damn about bug - here are famous examples of it - these bugs can legally drink in Europe and US, and they are older than am I! [Tooltips bug](https://bugzilla.mozilla.org/show_bug.cgi?id=148624), [Textarea bug](https://bugzilla.mozilla.org/show_bug.cgi?id=33654)

## Why??

I don't know what is Firefox doing with [Google's money](https://www.theverge.com/news/660548/firefox-google-search-revenue-share-doj-antitrust-remedies), but I'm pretty sure that this money is poorly spent on shit that no one wants and they light years behind Chromium and even Webkit aka Safari when it comes to features support. Need examples? Here are some:
...
And of course, there might be even better examples, but these are some off the top of my head. I fully understand that they are competing with two tech giants with most likely bigger budgets then Mozilla have, but I believe that better money spending whilte trying to keep up with competitors and proposing new stuff would make their browser more appealing to people, cause I feel like statistical user don't care about privacy as much as we, programmers/tech people do and in the end they would have bigger income, so is more money to improve browser and so.

## The end

To sum up, I'm pissed with Firefox bugs, inconsistency but I'm still going to use it and develop software with it in mind, mostly because my boss wants to ;) Thanks for reading, hope to hear comments about my short rant and what do **you** think about it.
